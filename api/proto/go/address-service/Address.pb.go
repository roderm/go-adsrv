...
var fileDescriptor_91f4fbe0bba4008f = []byte{
	...
	,
}
...
type AddressClient interface {
	...
	Get(ctx context.Context, in *address.AddressSub, opts ...grpc.CallOption) (Address_GetClient, error)
...
func (c *addressClient) Get(ctx context.Context, in *address.AddressSub, opts ...grpc.CallOption) (Address_GetClient, error) {
...
type AddressServer interface {
	...
	Get(*address.AddressSub, Address_GetServer) error
...
func (*UnimplementedAddressServer) Get(req *address.AddressSub, srv Address_GetServer) error {
